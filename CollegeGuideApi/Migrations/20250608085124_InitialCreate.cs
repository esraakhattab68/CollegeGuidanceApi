    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinancialAidTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScholarshipItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScholarshipItems_ScholarshipCategories_ScholarshipCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DurationOfStudy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditHours = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PreTest = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Deadline = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaymentMethod = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FirInstalment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecInstalment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AppFeesEgy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FeesEgy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AppFeesInt = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FeesInt = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedColleges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SavedColleges_Colleges_CollegeId",
                        column: x => x.CollegeId,
                        principalTable: "Colleges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedColleges_Users_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FutureJobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FutureJobs_Departments_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FutureJobs_DepartmentId",
                table: "FutureJobs",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedColleges_CollegeId",
                table: "SavedColleges",
                column: "CollegeId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedColleges_StudentId",
                table: "SavedColleges",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_ScholarshipItems_ScholarshipCategoryId",
                table: "ScholarshipItems",
